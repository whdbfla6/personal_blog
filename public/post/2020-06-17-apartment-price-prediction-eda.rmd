...
```
![png](https://focused-elion-b6663c.netlify.app/pics/output_34_1.png)
...
![png](https://focused-elion-b6663c.netlify.app/pics/output_39_1.png)

##### area 
- 면적이 300이상인 아파트들은 찾아보기 힘들다. 대부분 200 이하의 값을 갖는다
- 면적이 400이상인 곳은 논현동, 도곡동, 방배동에 위치한 아파트다
![png](https://focused-elion-b6663c.netlify.app/pics/output_43_1.png)
...
```
![png](https://focused-elion-b6663c.netlify.app/pics/output_52_1.png)
...
```
![png](https://focused-elion-b6663c.netlify.app/pics/output_60_1.png)
...
![png](https://focused-elion-b6663c.netlify.app/pics/output_72_1.png)
...
```
![png](https://focused-elion-b6663c.netlify.app/pics/output_75_1.png)

- 비율이 커질수록 아파트의 실거래가가 높아진다 
![png](https://focused-elion-b6663c.netlify.app/pics/output_77_1.png)

- 구간별로 살펴보았을 때 자치구 세대수 인구 대비 학교 학생수의 비율이 커질수록, 실거래가 커지는 경향

### 3) 세대당 주차대수 apartment_parking
- 세대당 주차대수는 0~2대 사이에 주로 분포
![png](https://focused-elion-b6663c.netlify.app/pics/output_80_1.png)
```python
figure,ax1 = plt.subplots()
...
![png](https://focused-elion-b6663c.netlify.app/pics/output_89_1.png)
...
![png](https://focused-elion-b6663c.netlify.app/pics/output_94_1.png)
...
![png](https://focused-elion-b6663c.netlify.app/pics/output_100_1.png)


##### st_volume
- 환승역이 4개인 곳의 실거래가가 2014년도 이후부터 꾸준히 증가하며, 환승역의 개수 별 거래액이 큰 차이를 보이지 않는다 > 제거

![png](https://focused-elion-b6663c.netlify.app/pics/output_103_1.png)
...
```
![png](https://focused-elion-b6663c.netlify.app/pics/output_108_1.png)
```python
